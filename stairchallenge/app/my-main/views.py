...
from stairchallenge.main.models import Reporter, Challenge, Report
from stairchallenge.main.forms import ChallengeForm, ActivityReportForm
...
def new_challenge( request ):
    ...
    return render_to_response('main/new_challenge.html', {'form': form } )
...
def challenges( request, challenge_id ):
    ...
    if( request.method == 'POST' ):
        ...
        return render_to_response( 'main/activity_report.html', locals() )
